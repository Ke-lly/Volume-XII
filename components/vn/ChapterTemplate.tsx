  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        {/* Imagem do Capítulo */}
        {image && (
          <div className="mt-8 rounded-2xl overflow-hidden shadow-2xl border border-white/5 pointer-events-none max-w-2xl mx-auto w-full h-[220px] md:h-[350px] bg-neutral-900/40 relative">
        ...
        <AnimatePresence mode="wait">
          {!storyFinished && currentLine && (
            <motion.div
              ...
              className="w-full mt-8 bg-black/80 backdrop-blur-xl border border-white/10 
                         p-6 md:p-8 rounded-3xl shadow-2xl z-40 pointer-events-none"
            >
              {currentLine.speaker && (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pb-12 mt-8">
                {prevUrl && (
                  <Link
                    href={prevUrl}
                    className="text-sm uppercase tracking-[0.2em] text-[#9f8d7a] hover:text-white transition duration-300"
                  >
                    ← Voltar Capítulo
                  </Link>
                )}
                ...
                {isLast ? (
                  ...
                  <motion.div whileHover={{ scale: 1.03 }}>
                    <Link
                      href={nextUrl}
                      className="bg-[#171717] border border-[#d4c1a7] text-[#f5ebe0] px-10 py-4 rounded-full hover:bg-[#f5ebe0] hover:text-black transition-all duration-500 text-sm uppercase tracking-[0.2em] font-medium block text-center"
                    >
                      Virar a Página ✨
                  </Link>
                </motion.div>
